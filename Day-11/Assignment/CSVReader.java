...
public class CSVReader {
    String[] dataFrame; //string array type
    ...
    public int fieldCount() {
        ...
        // Your code goes here....
        if(dataFrame.length > 0) {
            String[] columns= dataFrame[0].split(",");   //we had fields in 0th row
     ...
     */
    public String[] getRow(int rowNumber) { //row starts from index 1
        // TODO
        // Your code goes here....
    ...
    public String[] getColumnValues(int index) {
        ...
        if(dataFrame.length > 0 && (index > 0 && index < fieldCount())) {
            ...
            for(int i = 1; i <= rowCount(); i++) {
                column[newIndex] = dataFrame[i].split(",")[index];  //row is splitted
                newIndex++;
            }
            return column;
        }
